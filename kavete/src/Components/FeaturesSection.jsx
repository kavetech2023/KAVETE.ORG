...
const FeaturesSection = () => {
  return (
    <div id="services" className="flex items-center p-2 justify-center flex-col">
        ...
        {feature.icon === "2" && <FileSearch size={35} color={"gray"}/>}
        {feature.icon === "3" && <MessageSquare size={35} color={"gray"}/>}
        {feature.icon === "4" && <BriefcaseBusiness size={35} color={"gray"}/>}
        {feature.icon === "5" && <CircleDollarSign size={35} color={"gray"}/>}
        {feature.icon === "6" && <ChartNoAxesCombined size={35} color={"gray"}/>}
                            </div>
                            <div>
